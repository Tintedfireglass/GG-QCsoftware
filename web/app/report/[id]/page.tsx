        ...
        <div className="font-sans text-black bg-white p-8 max-w-[210mm] mx-auto min-h-screen">
            ...
            <header className="border-b-2 border-black pb-4 mb-6 flex justify-between items-end">
                ...
                <div className="text-right">
                    ...
                    {data.technician_label && (
                        <div className="text-sm text-gray-600 mt-1">
                            Technician: {data.technician_label}
                        </div>
                    )}
                </div>
            </header>
            ...
            {/* Physical Assessment */}
            {(data.physical_condition || data.scratches_and_dents) && (
                <div className="mb-8 border border-gray-300 p-4 rounded bg-gray-50 break-inside-avoid">
                    <h3 className="font-bold text-xs uppercase text-gray-500 mb-3">Physical Assessment</h3>
                    <table className="w-full text-sm">
                        <tbody>
                            {data.physical_condition && (
                                <tr className="border-b border-dotted border-gray-300">
                                    <td className="py-2 text-gray-600 w-1/3">Physical Condition</td>
                                    <td className="py-2 font-medium">{data.physical_condition as string}</td>
                                </tr>
                            )}
                            {data.scratches_and_dents && (
                                <tr>
                                    <td className="py-2 text-gray-600 w-1/3">Scratches &amp; Dents</td>
                                    <td className="py-2 font-medium">{data.scratches_and_dents as string}</td>
                                </tr>
                            )}
                        </tbody>
                    </table>
            ...
            <footer className="mt-12 pt-6 border-t border-gray-300 text-center text-xs text-gray-500 flex justify-between">
                <div>Generated by {branding.siteName}</div>
