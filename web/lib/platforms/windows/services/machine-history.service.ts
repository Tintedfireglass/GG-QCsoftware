...
import { SubmitMachineHistoryInput, AlertsQuery } from '@/lib/platforms/windows/domain/schemas/machine-history';
import * as repo from '@/lib/platforms/windows/repositories/machine-history.repo';
